...
class Scraper:
  ...
  def analyze_single_bond(self, url: str) -> Bond:
      ...
      bond.emission_date = datetime.datetime.strptime(self.find_value_from_label("Data Inizio Negoziazione",soup), '%d/%m/%y')
      bond.coupon_frequency = Frequency.of(self.find_value_from_label("Periodicità cedola",soup))
      ...
      bond.maturity_date = datetime.datetime.strptime(self.find_value_from_label("Scadenza",soup_complete_data), '%d/%m/%y')
